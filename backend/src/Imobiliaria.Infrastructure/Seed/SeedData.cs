...
public static class SeedData
{
    public static void Initialize(AppDbContext context)
    {
        ...
        if (context.Usuarios.Any()) return; // Já tem dados
        ...
        var gerente = new Usuario
        {
            ...
            SenhaHash = HashSenha("gerente123"),
            Perfil = PerfilUsuario.Gerente
        };
        var usuarioCorretor1 = new Usuario
        {
            Nome = "Carlos Silva",
            Email = "carlos@imobiliaria.com",
            SenhaHash = HashSenha("corretor123"),
            Perfil = PerfilUsuario.Corretor
        };
        var usuarioCorretor2 = new Usuario
        {
            Nome = "Ana Oliveira",
        ...
        {
            Nome = "Carlos Silva",
            CRECI = "CRECI-12345/PR",
            Email = "carlos@imobiliaria.com",
            Telefone = "(44) 99999-1111",
            UsuarioId = usuarioCorretor1.Id
        };
        var corretor2 = new Corretor
        {
            Nome = "Ana Oliveira",
            CRECI = "CRECI-67890/PR",
            Email = "ana@imobiliaria.com",
            Telefone = "(44) 99999-2222",
            UsuarioId = usuarioCorretor2.Id
        };
        ...
        var prop3 = new Proprietario
        {
            Nome = "Construtora ABC Ltda",
            CPFouCNPJ = "12.345.678/0001-00",
        ...
        {
            Titulo = "Casa Ampla com Piscina - Jardim América",
            Descricao = "Linda casa com 3 suítes, piscina aquecida, churrasqueira gourmet e jardim. Acabamento de alto padrão, porcelanato em todos os ambientes. Rua tranquila e arborizada.",
            Codigo = "CAS-001",
        ...
        {
            Titulo = "Apartamento Moderno - Zona 7",
            Descricao = "Apartamento de 2 dormitórios com sacada gourmet. Condomínio com academia, salão de festas e playground. Próximo a escolas e supermercados.",
            Codigo = "APT-001",
            Tipo = TipoImovel.Apartamento,
            Finalidade = FinalidadeImovel.Locacao,
            Status = StatusImovel.Disponivel,
            PrecoLocacao = 2200m,
            ValorCondominio = 450m,
            ValorIPTU = 1200m,
            AreaTotal = 75,
            AreaConstruida = 68,
            Dormitorios = 2,
        ...
        // 3. Sobrado para venda
        var end3 = new Endereco
        {
            Logradouro = "Rua Pioneiro Antonio Ruiz",
            Numero = "880",
        ...
        var imovel3 = new Imovel
        {
            ...
            Codigo = "SOB-001",
            Tipo = TipoImovel.Sobrado,
            Finalidade = FinalidadeImovel.Venda,
            Status = StatusImovel.Disponivel,
            PrecoVenda = 620000m,
            ValorCondominio = 600m,
            ValorIPTU = 2800m,
            AreaTotal = 250,
            AreaConstruida = 180,
            Dormitorios = 3,
        ...
        // 4. Apartamento para venda e locação
        var end4 = new Endereco
        {
            Logradouro = "Avenida Colombo",
            Numero = "5500",
            Complemento = "Torre A, Apto 1502",
            Bairro = "Zona 7",
            Cidade = "Maringá",
            Estado = "PR",
            CEP = "87020-900"
        ...
        var imovel4 = new Imovel
        {
            ...
            Descricao = "Cobertura duplex com vista panorâmica da cidade. 4 suítes, sala ampla, varanda gourmet com churrasqueira. Acabamento de luxo.",
            Codigo = "COB-001",
            Tipo = TipoImovel.Cobertura,
            Finalidade = FinalidadeImovel.VendaELocacao,
            Status = StatusImovel.Disponivel,
            PrecoVenda = 1200000m,
            PrecoLocacao = 6500m,
            ValorCondominio = 1200m,
            ValorIPTU = 5000m,
            AreaTotal = 200,
            AreaConstruida = 200,
            Dormitorios = 4,
        ...
        {
            Titulo = "Kitnet Centro - Ideal Estudantes",
            Descricao = "Kitnet bem localizada no centro da cidade, próxima à UEM. Mobiliada com cama, guarda-roupa e fogão. Água e gás inclusos.",
            Codigo = "KIT-001",
            Tipo = TipoImovel.Kitnet,
            Finalidade = FinalidadeImovel.Locacao,
            Status = StatusImovel.Disponivel,
            PrecoLocacao = 800m,
            AreaTotal = 28,
        ...
        {
            Titulo = "Terreno 450m² - Excelente Localização",
            Descricao = "Terreno plano em bairro residencial com toda infraestrutura. Pronto para construir. Documentação em dia.",
            Codigo = "TER-001",
        ...
        var imovel7 = new Imovel
        {
            ...
            Descricao = "Sala comercial em edifício empresarial com elevador e estacionamento. Ideal para escritórios e consultórios.",
            Codigo = "SAL-001",
            Tipo = TipoImovel.SalaComercial,
            Finalidade = FinalidadeImovel.Locacao,
            Status = StatusImovel.Disponivel,
            PrecoLocacao = 1800m,
            ValorCondominio = 350m,
            AreaTotal = 45,
            AreaConstruida = 45,
            Dormitorios = 0,
            Banheiros = 1,
        ...
        // 8. Casa já alugada (status diferente)
        var end8 = new Endereco
        {
