...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "Imobiliária ERP API", Version = "v3", Description = "ERP Imobiliário — V3 com Auditoria, Fotos, CRUD Admin e Portal do Cliente" });
